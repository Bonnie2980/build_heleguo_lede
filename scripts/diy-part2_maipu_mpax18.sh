...
# 修改闭源驱动2G wifi名称
sed -i 's/SSID1=MTK_HARRIER_AP_2.4G/SSID1=MAIPU_MPAX18-2.4G/g' package/mtk/wifi-profile/files/mt7915/mt7915.dbdc.b0.dat
sed -i 's/SSID1=MTK_HARRIER_AP_2.4G/SSID1=MAIPU_MPAX18-2.4G/g' package/mtk/wifi-profile/files/mt7915/wifi_cert.1.dat

# 修改闭源驱动5G wifi名称
sed -i 's/SSID1=MTK_HARRIER_AP_5G/SSID1=MAIPU_MPAX18-5G/g' package/mtk/wifi-profile/files/mt7915/mt7915.dbdc.b1.dat
sed -i 's/SSID1=MTK_HARRIER_AP_5G/SSID1=MAIPU_MPAX18-5G/g' package/mtk/wifi-profile/files/mt7915/wifi_cert.2.dat
